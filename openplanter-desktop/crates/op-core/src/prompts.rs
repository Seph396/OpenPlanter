...
pub const SESSION_LOGS_SECTION: &str = r#"
...
pub const TURN_HISTORY_SECTION: &str = r#"
== TURN HISTORY ==
...
pub const RECURSIVE_SECTION: &str = r#"
== REPL STRUCTURE ==
...
/// Assemble the full system prompt, mirroring `build_system_prompt()`.
pub fn build_system_prompt(recursive: bool, acceptance_criteria: bool, demo: bool) -> String {
    ...
    if acceptance_criteria {
        prompt.push_str(ACCEPTANCE_CRITERIA_SECTION);
    }
    if demo {
...
mod tests {
    ...
    #[test]
    fn test_build_system_prompt_recursive_only() {
    ...
    fn test_prompt_section_ordering() {
        ...
        let demo_pos = prompt.find("Demo Mode").unwrap();
